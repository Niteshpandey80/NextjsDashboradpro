      ...
      <div className='max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {metrics.map((metric , index)=>(
            <div key={index} className={`flex justify-between items-center bg-white rounded-lg shadow-md p-6 border-l-4 ${metric.isPositive ? "border-green-500":
            "border-red-500"  
            }`}>
              <div>
        ...
        <div className='mb-8'>
          ...
          <div className='bg-gray-100 text-gray-700 rounded-lg h-72 '>Charts Placeholder</div>
        </div>
         <div className='mb-8'>
          <h2 className='text-xl font-semibold text-gray-700 mb-4'>Website Traffic</h2>
          <div className='bg-gray-100 text-gray-700 rounded-lg h-72 '>Charts Placeholder</div>
        ...
        <div className="mb-8">
        <h2 className='text-xl font-semibold text-gray-700 mb-4'>Recent Actitivites</h2>
